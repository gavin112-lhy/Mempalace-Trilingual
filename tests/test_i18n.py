...
from mempalace_tri.i18n import load_lang, t, available_languages
from mempalace_tri.dialect import Dialect
...
def test_direct_address_key_is_singular_string_for_all_locales():
    ...
    """
    from mempalace_tri.i18n import _load_entity_section, available_languages

...
from mempalace_tri.entity_detector import (
    PROSE_EXTENSIONS,
    STOPWORDS,
    _print_entity_list,
    classify_entity,
...
def test_build_patterns_cache_is_keyed_by_language():
    ...
    from mempalace_tri.entity_detector import _build_patterns
...
def test_normalize_langs_handles_string_input():
    ...
    from mempalace_tri.entity_detector import _normalize_langs

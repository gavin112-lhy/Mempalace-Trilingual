...
class TestClosetsExist:
    ...
    def test_closets_importable(self):
        """get_closets_collection should be importable from mempalace_tri.palace."""
        from mempalace_tri.palace import get_closets_collection
...
class TestStripNoise:
    ...
    def test_strip_noise_importable(self):
        """strip_noise should be importable from mempalace_tri.normalize."""
        from mempalace_tri.normalize import strip_noise
...
class TestTunnelFunctions:
    ...
    def test_tunnel_functions_importable(self):
        ...
        from mempalace_tri.palace_graph import find_tunnels, traverse, graph_stats
...
class TestMineLock:
    ...
    def test_mine_lock_importable(self):
        """mine_lock should be importable from mempalace_tri.palace."""
        from mempalace_tri.palace import mine_lock
...
class TestBackendAbstraction:
    ...
    def test_backends_importable(self):
        ...
        from mempalace_tri.backends.base import BaseCollection
        from mempalace_tri.backends.chroma import ChromaBackend

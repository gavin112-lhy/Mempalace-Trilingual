...
def _patch_mcp_config(monkeypatch, palace_path, tmp_path):
    ...
    from mempalace_tri.config import MempalaceConfig
    from mempalace_tri.knowledge_graph import KnowledgeGraph
...
class TestClientReinstantiation:
    ...
    def test_reinstantiation_overhead(self, tmp_path, monkeypatch):
        ...
        from mempalace_tri.mcp_server import _get_collection

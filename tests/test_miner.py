...
from mempalace_tri.miner import load_config, mine, scan_project, status
from mempalace_tri.palace import NORMALIZE_VERSION, file_already_mined
...
def test_entity_metadata_finds_cyrillic_names(monkeypatch):
    ...
    from mempalace_tri.miner import _extract_entities_for_metadata
...
def test_add_drawer_stamps_normalize_version(tmp_path):
    ...
    from mempalace_tri.miner import add_drawer

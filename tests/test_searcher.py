...
from mempalace_tri.searcher import SearchError, search, search_memories
...
class TestBM25NoneSafety:
    ...
    def test_tokenize_handles_none(self):
        from mempalace_tri.searcher import _tokenize
    ...
    def test_bm25_scores_does_not_crash_on_none_documents(self):
        ...
        from mempalace_tri.searcher import _bm25_scores

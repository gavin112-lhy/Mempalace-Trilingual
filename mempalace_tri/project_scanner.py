...
def discover_entities(
    ...
    from mempalace_tri.convo_scanner import is_claude_projects_root, scan_claude_projects
    ...
    if llm_provider is not None:
        from mempalace_tri.llm_refine import collect_corpus_text, refine_entities
    ...
    if corpus_origin is not None:
        from mempalace_tri.entity_detector import _apply_corpus_origin

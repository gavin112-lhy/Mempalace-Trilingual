"""MemPalace Trilingual — 三语记忆宫殿. Give your AI a memory. No API key required."""
...
# Trilingual compressor exports
from .compressor import Compressor, CompressorMode, detect_language  # noqa: E402

__all__.extend(["Compressor", "CompressorMode", "detect_language"])
